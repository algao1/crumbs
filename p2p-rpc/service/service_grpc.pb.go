...
func (c *pingServiceClient) Ping(ctx context.Context, in *PingRequest, opts ...grpc.CallOption) (*PongReply, error) {
	out := new(PongReply)
...
func (UnimplementedPingServiceServer) Ping(context.Context, *PingRequest) (*PongReply, error) {
...
var PingService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "p2p-rpc/service/service.proto",
}
